...
Aquí creamos el universo que utilizaremos para hacer los enriquecimientos funcionales.

```{r}
# Esto asume que rownames(expression.level) tiene los IDs tipo "TCxxxxx"
universe_ids <- rownames(expression.level)
...
Aquí los repressed de la condicion anterior
...
# 8. Visualización
barplot(ego_ko_24m_vs_wt_24m_repressed, showCategory = 5)

```

Aquí no sale ninguno porque como es lógico con tan pocos genes no puede haber rutas activadas o reprimidas.
